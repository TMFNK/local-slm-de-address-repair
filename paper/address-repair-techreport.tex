...
nothing. Runtime was measured on one 8~GB machine; the memory figures
are startup probes and do not claim a full-run process maximum. The frozen comparison is one
...
\cite{repo} at evaluation commit \texttt{bd50ecc}; the v3 Colab
